        ...
        <div class="wrapper">
            ...
            <div class="middle">
                ...
                <div style="margin-left: 10px;"> 
                    ...
                    <br>
					<center><span class="link"><a href="fund_urgent_additional.php">SUBMIT URGENT ADDITONAL</a></span></center>
                    <div class="table">
                            ...
                            <table class="data display datatable" id="example">
                                ...
                                while (@$rs_data = mysql_fetch_array($sql_data)) {
                                    ...
                                    echo "<td>";?><a onclick="window.open('fund_print.php?b_req=1&fund_id=<?php echo @$rs_data['afr_id'].'&branch='.@$rs_data['branch_id'];?>','', 'height=500,width=1000,top=100,left=200')"><input type="button" value="Print"></a> <?php echo $row_branch['branch_name'] . "</td>";
                                ...
                                ?>
								<?php
									while($row_urg = mysql_fetch_array($sql_urg)){
										
										$sql_branch = mysql_query("SELECT * FROM branches WHERE branch_id='".$row_urg['branch_id']."' ");
										$row_branch = mysql_fetch_array($sql_branch);
										
										echo '<tr>
												<td>'.$row_urg['date'].'</td>
												<td>'.$row_branch['branch_name'].'</td>
												<td>'.$row_urg['urgent_additional'].'</td>
												<td>';?><a onclick="window.open('fund_print.php?date=<?php echo $row_urg['date'].'&branch='.$row_urg['branch_id'];?>','', 'height=500,width=1000,top=100,left=200')"><input type="button" value="Print"></a><?php echo '</td>
												<td></td>
												<td></td>
											</tr>';
									}
