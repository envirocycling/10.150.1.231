            ...
            $(document).ready(function () {
                ...
                $("#submit").click(function () {
                    ...
                    if (message == true) {
                        ...
                        var myData = 'emp_id=' + emp_id + '&ref_no=' + ref_no + '&date=' + date + '&amount=' + amount + '&purpose=' + purpose + '&approve_id=' + approve_id;
                        $.ajax({
                            type: "POST",
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><select id="approve_id" class="medium-select" required>
                                        <option value=""></option>
                                        <?php
                                        $sql_user = mysql_query("SELECT * FROM users WHERE (position LIKE '%GENERAL%' or position LIKE '%BH%' or position LIKE '%HR%' or position LIKE '%SUPERVISOR%')");
