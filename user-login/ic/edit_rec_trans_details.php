...
if (isset($_POST['submit'])) {
    mysql_query("UPDATE scale_receiving SET str_no='" . $_POST['str_no'] . "', supplier_id='" . $_POST['supplier_id'] . "',upload='0',up_paper='0',checked='1' WHERE trans_id='" . $_GET['trans_id'] . "'");

    mysql_query("UPDATE scale_outgoing SET str_no='" . $_POST['str_no'] . "', supplier_id='" . $_POST['supplier_id'] . "',upload='0',up_out='0',checked='1' WHERE rec_trans_id='" . $_GET['trans_id'] . "'");
}
...
echo "<form action='edit_rec_trans_details.php?trans_id=" . $_GET['trans_id'] . "' method='POST'>";
echo "<table>";
echo "<tr>";
echo "<td><b>Date: </td>";
echo "<td><u>$date</u></td>";
