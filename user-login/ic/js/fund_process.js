$(window).load(function () {
				...
				var count3 = Number($("#hidden-count1").val());
					...
					var t_req = (tot_req_sauyo2 + tot_req_cai2 + tot_req_cal2 + tot_req_cav2 + tot_req_kay2 + tot_req_man2 + tot_req_pas2 + tot_req_urd2).toFixed(2);
					$("#t_fund" ).html(t_req);
					...
					var t_funds = (tot_fund_urd + tot_fund_pas + tot_fund_man + tot_fund_kay + tot_fund_cav + tot_fund_cal + tot_fund_cai + tot_fund_sauyo).toFixed(2);
					$("#t_fundadd").html(t_funds);
						...
						var tot_reval = (reval_sau + reval_cai + reval_cal + reval_cav + reval_kay + reval_man + reval_pas + reval_urd).toFixed(2);
					...
					var ex_sau1 = $('#exval_' + sau).val().replace(/\,/g,"");
						...
						var tot_ex = (ex_urd + ex_pas + ex_man + ex_kay + ex_cav + ex_cal + ex_cai + ex_sau).toFixed(2);
			 ...
			 function save(){
				...
				if(mes == true){
						...
						if(av != '' && av >= 1){
							...
							alert(myDate);
					/*
							var myData = '2=' + val_cai + '&3=' + val_cal + '&4=' + val_cav + '&5=' + val_kay + '&6=' + val_sau + '&12=' + val_man + '&9=' + val_pas + '&10=' + val_urd + '&av=' + av + '&tr_6=' + totreq_sau + '&tr_2=' + totreq_cai + '&tr_4=' + totreq_cav + '&tr_5=' + totreq_kay + '&tr_3=' + totreq_cal + '&tr_12=' + totreq_man + '&tr_9=' + totreq_pas + '&tr_10=' + totreq_urd + '&af_6=' + addfund_sau + '&af_2=' + addfund_cai + '&af_3=' + addfund_cal + '&af_4=' + addfund_cav + '&af_5=' + addfund_kay + '&af_12=' + addfund_man + '&af_9=' + addfund_pas + '&af_10=' + addfund_urd + '&ex_2=' + ex_cai + '&ex_3=' + ex_cal + '&ex_4=' + ex_cav + '&ex_5=' + ex_kay + '&ex_6=' + ex_sau + '&ex_12=' + ex_man + '&ex_9=' + ex_pas + '&ex_10=' + ex_urd + '&totmbal_10=' + totmbal_urd  + '&totmbal_9=' + totmbal_pas  + '&totmbal_12=' + totmbal_man + '&totmbal_5=' + totmbal_kay + '&totmbal_4=' + totmbal_cav + '&totmbal_3=' + totmbal_cal + '&totmbal_2=' + totmbal_cai + '&totmbal_6=' + totmbal_sau + '&time=' + time + '&myDate=' + myDate;
