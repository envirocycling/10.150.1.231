        ...
        <div class="wrapper">
            ...
            <div class="middle">
                ...
                <div align="center">
                    ...
                    <?php
                    if (isset($_POST['submit'])) {
                        echo '<iframe  src="iframe/query_receiving.php?from=' . $_POST['from'] . '&to=' . $_POST['to'] . '" width="1250" height="500" scrolling="yes"></iframe>';
                    } else {
                        echo '<iframe  src="iframe/query_receiving.php?from=' . date('Y/m/d') . '&to=' . date('Y/m/d') . '" width="1250" height="500" scrolling="yes"></iframe>';
                    }
                    ?>
                </div>
