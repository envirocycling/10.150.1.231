...
if ($rs_rec['status'] == 'paid') {
    echo "<script>
        alert('This is already proccess for payment.');
        </script>";
}
...
while ($rs_rec_details = mysql_fetch_array($sql_rec_details)) {
    ...
    echo "<td align='center'>";
    ?>
    <!--<a href='del_rec_details.php?trans_id=<?php // echo $_GET['trans_id']; ?>&detail_id=<?php // echo $rs_rec_details['detail_id']; ?>'><button onclick="return confirm('Are you sure you want to delete this line?')">Delete</button></a>-->
    <?php
    echo "</td>";
    echo "</tr>";
    $ctr++;
