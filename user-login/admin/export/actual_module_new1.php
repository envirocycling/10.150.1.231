...
?>
<script>
window.top.location.href = "http://192.168.10.200/paymentsystem/user-login/admin/export/export_to_ims.php?strno=<?php echo $str.'& tid='.$id.'& update=yes';?>";
</script>
<?php
...
<script>
alert("System Error.");
window.top.location.href = "http://192.168.10.200/paymentsystem/user-login/admin/export/export_to_ims.php"; 
</script>
<?php
}
