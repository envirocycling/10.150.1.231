...
<table width="90%" height="200">
	<tr height="15px">
		<td align="center"><h1>Updating Outgoing</h1><br />
...
<?php
 $url = 'http://ims.efi.net.ph/pampanga_outgoing_module_new1.php';
    $ch = curl_init($url);
...
$update =mysql_query("UPDATE scale_outgoing SET up_out='1' WHERE trans_id='$id' and str_no='$str'") or die (mysql_error());
}
