...
var attr=obj.attributes[name];
if(attr==null||attr==undefined){
//Try to another method (Firefox does not allow using capitals in attribute names)
...
CssFn+='src:url(\''+Path+'MG_Icons.eot\');';
        ...
        CssFn+='    url(\''+Path+'MG_Icons.woff?#665238382\') format(\'woff\'),';
        CssFn+='    url(\''+Path+'MG_Icons.ttf?#665238382\') format(\'truetype\');';
...
function AddCss_MyMenu1(Path){
    ...
    var Css='.mn898CShdBtm{height:5px;*filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\''+Path+'ShadowBottom.png\', sizingMethod=\'crop\');background:transparent url('+Path+'ShadowBottom.png);}.mn898CShdCrn{width:12px;height:5px;*filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\''+Path+'ShadowCorner.png\', sizingMethod=\'crop\');background:transparent url('+Path+'ShadowCorner.png);}.mn898CShdRgt{width:5px;*filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\''+Path+'ShadowRight.png\', sizingMethod=\'crop\');background:transparent url('+Path+'ShadowRight.png);}.mn898CShdCmn{position:absolute;display:-moz-inline-stack;display:inline-block;zoom:1;*display:inline;background-repeat:no-repeat;*background-image:none;*background-color:Transparent;padding:0px;}.mn898CMainMenuDIV TD, .mn898CSubMenuDIV TD {vertical-align: middle;border: none;padding: 0px;}.mn898CDefaults {color: #006F8C;OverlapVertical: 0px;OverlapHorizontal: 1px;}.mn898CIconTD, .mn898CTitleTD, .mn898CArrowTD {text-shadow: none;font-size: 14px;font-family: Arial;white-space: nowrap;padding: 0px;line-height: normal;vertical-align: middle;font-weight: bold !important;}.mn898CTitleTD {text-align: left;}.mn898CIconTD font, .mn898CArrowTD font {margin: 0 !important;display: block !important;padding: 0px;line-height: 14px;}.mn898CMainMenuDIV {padding: 0px;padding-left: 4px;padding-right: 4px;background-color: #C0C0C0;background-image: url(\''+Path+'Background.png?v=828860\');background-repeat: repeat-x;background-position: left center;cursor: default;}.mn898CMainMenuDIV TABLE {border-collapse: separate;margin: 0px;padding: 0px;}.mn898CMainMenuDIV{width:1300px;overflow:hidden;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;}.mn898CMainMenuItemTD {padding: 8px !important;}.mn898CMainMenuItemTD .mn898CTitleTD, .mn898CMainMenuItemTD .mn898CIconTD, .mn898CMainMenuItemTD .mn898CArrowTD {color: #5C5C5C;}.mn898CMainMenuItemHoveredTD {padding: 8px !important;background-color: #008FB4;background-image: url(\''+Path+'Background_add.png?v=828860\');background-repeat: repeat-x;background-position: left center;cursor: default;cursor: hand;cursor: pointer;}.mn898CMainMenuItemHoveredTD .mn898CTitleTD, .mn898CMainMenuItemHoveredTD .mn898CIconTD, .mn898CMainMenuItemHoveredTD .mn898CArrowTD {color: #FFFFFF;text-shadow: 0px 1px 1px #003E4E;}.mn898CMainMenuItemSelectedTD {padding: 8px !important;background-color: #BCBCBC;background-image: url(\''+Path+'Background2.png?v=828860\');background-repeat: repeat-x;background-position: left center;}.mn898CMainMenuItemSelectedTD .mn898CTitleTD, .mn898CMainMenuItemSelectedTD .mn898CIconTD, .mn898CMainMenuItemSelectedTD .mn898CArrowTD {color: #5C5C5C;}.mn898CSubMenuDIV {-moz-box-sizing: content-box;-webkit-box-sizing: content-box;box-sizing: content-box;padding: 0px;padding-top: 4px;padding-bottom: 4px;background-color: #006F8C;border: solid 1px #696969;border-color: #0094BA;border-right-color: #004658;border-bottom-color: #004658;cursor: default;}.mn898CSubMenuDIV TABLE {border-collapse: separate;width: auto !important;margin: 0px;padding: 0px;}.mn898CSubMenuItemTD, .mn898CSubResDIV {padding: 6px !important;padding-left: 8px !important;padding-right: 8px !important;}.mn898CSubMenuItemTD .mn898CTitleTD, .mn898CSubMenuItemTD .mn898CIconTD, .mn898CSubMenuItemTD .mn898CArrowTD, .mn898CSubResDIV {color: #FFFFFF;text-shadow: 0px 1px 1px #003E4E;}.mn898CSubMenuItemHoveredTD, .mn898CSubResDIV:hover {padding: 6px !important;padding-left: 8px !important;padding-right: 8px !important;background-color: #00ADDA;cursor: default;cursor: hand;cursor: pointer;}.mn898CSubMenuItemHoveredTD .mn898CTitleTD, .mn898CSubMenuItemHoveredTD .mn898CIconTD, .mn898CSubMenuItemHoveredTD .mn898CArrowTD, .mn898CSubResDIV:hover {color: #FFFFFF;text-shadow: 0px 1px 1px #005970;}.mn898CSubMenuItemSelectedTD {padding: 6px !important;padding-left: 8px !important;padding-right: 8px !important;background-color: #0089AC;}.mn898CSubMenuItemSelectedTD .mn898CTitleTD, .mn898CSubMenuItemSelectedTD .mn898CIconTD, .mn898CSubMenuItemSelectedTD .mn898CArrowTD {color: #FFFFFF;text-shadow: 0px 1px 1px #003746;}.mn898CSeparatorVerticalTD {padding: 0px !important;background-color: #D5D5D5;background-image: url(\''+Path+'BackgroundSpr.png?v=828860\');background-repeat: no-repeat;background-position: left center;}.mn898CSeparatorVerticalTD TABLE {width: 2px !important;}.mn898CSeparatorHorizontalTD {padding: 0px !important;border-top-style: solid !important;border-top-width: 1px !important;border-top-color: #004658 !important;background-color: #0094BA;}.mn898CTooltipDIV {font-family: Arial;font-size: 12px;color: #555555;padding: 3px;padding-left: 5px;padding-right: 5px;background-color: #F8F8F8;border: solid 1px #888888;border-radius: 3px;-webkit-border-radius: 3px;-khtml-border-radius: 3px;-moz-border-radius: 3px;}.mn898CIconTD {color: #000000;vertical-align: middle;text-align: center;}.mn898CIconTD font {font-size: 16px;padding-left: 2px;padding-right: 8px;width: 16px;}';
...
var MyMenu1={
    ...
    Prepare:function(){
        ...
        AddCss_MyMenu1(Path);
mnFE0BBC45L=new mnFE0BBC45LCn(Path);MyMenu1.Mnu='<div><input id="sit_mnFE0BBC45_vs" name="sit_mnFE0BBC45_vs" type="hidden" value="" /></div><div id="mnFE0BBC45_-0p" class="mn898CMainMenuDIV" onmouseover="dm.vD();" onmouseout="dm.uD();" style="z-index:10000;position:static;vertical-align:top;display:-moz-inline-stack;display:inline-block;zoom:1;*display:inline;"><table border="0" cellspacing="0" cellpadding="0" onclick="dm.mc();"><tr><td onmouseover="dm.v(this,1);" onmouseout="dm.u(this);" id="mnFE0BBC45_i3" onclick="dm.ItClk(this,\'\');cmn.href(\'index.php\',\'\');" class="mn898CMainMenuItemTD"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="mn898CIconTD">&nbsp;</td><td class="mn898CTitleTD" id="mnFE0BBC45_i3-tl">Home</td><td class="mn898CArrowTD">&nbsp;</td></tr></table></td><td onmouseover="dm.v(this,1);" onmouseout="dm.u(this);" id="mnFE0BBC45_i2" onclick="dm.ItClk(this,\'\');cmn.href(\'view_receiving.php\',\'\');" class="mn898CMainMenuItemTD"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="mn898CIconTD">&nbsp;</td><td class="mn898CTitleTD" id="mnFE0BBC45_i2-tl">Receiving</td><td class="mn898CArrowTD">&nbsp;</td></tr></table></td><td onmouseover="dm.v(this,1);" onmouseout="dm.u(this);" id="mnFE0BBC45_i12" onclick="dm.ItClk(this,\'\');cmn.href(\'report.php\',\'\');" class="mn898CMainMenuItemTD"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="mn898CIconTD">&nbsp;</td><td class="mn898CTitleTD" id="mnFE0BBC45_i12-tl">Report</td><td class="mn898CArrowTD">&nbsp;</td></tr></table></td></tr></table></div>';MyMenu1.SubMnu='<div id="mnFE0BBC45ifc"></div>';
        /**/
    },
