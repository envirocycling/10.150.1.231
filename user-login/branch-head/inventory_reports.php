    ...
    <body>
        <div class="wrapper">
            ...
            <div class="middle" align="center">
                ...
                <br>
                <form action="inventory_reports.php" method="POST">
                    Deliveries To: <?php
                    echo "<select id='delivered_to' name='delivered_to'>";
                    if ($_POST['submit'] && $_POST['delivered_to'] != '') {
                        $sql_dt = mysql_query("SELECT * FROM delivered_to WHERE dt_id='" . $_POST['delivered_to'] . "'");
                ...
                <?php
                if (isset($_POST['submit'])) {
                    echo '<iframe src="iframe/query_inventory.php?from=' . $_POST['from'] . '&to=' . $_POST['to'] . '&branch=' . $_POST['branch'] . '&delivered_to=' . $_POST['delivered_to'] . '" width="1160" height="500" scrolling="yes"></iframe>';
                } else {
