                    ...
                    <div class="table">
                        <table class="data display datatable" id="example">
                            ...
                            if (isset($_POST['from'])) {
                                ...
                                $sql_data = mysql_query("SELECT * FROM adv WHERE date>='$date_from' and date<='$date_to' and status!='cancelled' and branch_id='" . $rs_branch_id['branch_id'] . "'");
                            } else {
                                $sql_data = mysql_query("SELECT * FROM adv WHERE status='' and branch_id='" . $rs_branch_id['branch_id'] . "'");
                            }
