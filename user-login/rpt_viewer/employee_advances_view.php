                ...
                <div align="center">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td valign="bottom"><?php if ($row_advances['status'] == 'approved' || $row_advances['status'] == 'issued' || $row_advances['status'] == 'liquidated') {
                    echo '<img src="../../signatures_pamp/' . $row_approver['initial'] . '.png" width="200px" height="100px">';
                } ?><br><?php echo $row_approver['firstname'] . ', ' . $row_approver['lastname'] . ' / ' . $row_approver['initial']; ?><font size="-2"><br><?php if ($row_advances['status'] == 'approved' || $row_advances['status'] == 'liquidated' || $row_advances['status'] == 'issued') {
                    echo date('Y-m-d h:i A', strtotime($row_advances['date_time_approved']));
                } ?></font></td>
                        </tr>
