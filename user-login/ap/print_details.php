...
// Conversion
        ...
        echo "<center>";
        echo "<table height='350' border='0'>";
        echo "<tr>";
        echo "<td style='vertical-align: top;' height='60' align='center'>";
        echo "<table border='0' width='672' cellspacing='1'>";
        echo "<tr>";
        echo "<td height='15'></td>";
        echo "<td align='right'>" . date("M") . "&nbsp;" . date("d") . ",&nbsp;" . date("Y") . "</td>";
        echo "</tr>";
        echo "<tr>";
        echo "<td height='15' align='center'>CONSOLIDATED PAYMENT</td>";
        echo "<td align='right'>" . $rs_payment['voucher_no'] . "</td>";
        echo "</tr>";
        echo "<tr>";
        echo "<td height='15' align='center'>* * * " . strtoupper(utf8_decode($rs_payment['cheque_name'])) . " * * *</td>";
        ...
        foreach ($que as $trans_id) {
            $sql_details = mysql_query("SELECT * FROM scale_receiving_details WHERE trans_id='$trans_id'");
            while ($rs_details = mysql_fetch_array($sql_details)) {
                ...
                $sql_trans = mysql_query("SELECT * FROM scale_receiving WHERE trans_id='" . $rs_details['trans_id'] . "'");
                $rs_trans = mysql_fetch_array($sql_trans);
                echo "<tr>";
                echo "<td width='350'>" . $rs_trans['date'] . " - " . $rs_mat['code'] . "</td>";
                $total+=$rs_details['corrected_weight'];
                echo "<td width='120'>" . number_format($rs_details['corrected_weight'], 2) . " KGS</td>";
                echo "<td width='130' align='center'>" . number_format($rs_details['price'], 2) . "</td>";
                echo "<td width='120' align='center'>" . number_format($rs_details['amount'], 2) . "</td>";
                echo "</tr>";
            }
        }
        echo "</table>";
        ...
        echo "<tr>";
        echo "<td colspan='4'>ADJUSTMENTS</td>";
        echo "</tr>";
		    $sql_adj = mysql_query("SELECT * FROM temp_payment_price_adj WHERE user_id='" . $_SESSION['user_id'] . "'");
    while ($rs_adj = mysql_fetch_array($sql_adj)) {
        if ($rs_adj['detail_id'] != "0") {
            $sql_mat = mysql_query("SELECT * FROM material WHERE material_id='" . $rs_adj['material_id'] . "'");
            $rs_mat = mysql_fetch_array($sql_mat);
            echo "<tr>";
            echo "<td width='350' style='vertical-align: top; padding-left: 15px;'>ADJ-PB</td>";
            echo "<td width='120' style='vertical-align: top;'></td>";
            echo "<td width='130' align='center' style='vertical-align: top;'></td>";
            echo "<td width='130' align='center' style='vertical-align: top;'>" . number_format($rs_adj['amount'], 2) . "</td>";
            echo "</tr>";
        }
    }
        ...
        while ($rs_adj = mysql_fetch_array($sql_adj)) {
            if ($rs_adj['adj_type'] != "") {
                echo "<tr>";
                echo "<td width='350' style='vertical-align: top;'>" . strtoupper($rs_adj['adj_type']) . "</td>";
                echo "<td width='120' style='vertical-align: top;'>" . strtoupper($rs_adj['desc']) . "</td>";
                echo "<td width='130' align='center' style='vertical-align: top;'></td>";
                echo "<td width='130' align='center' style='vertical-align: top;'>";
        ...
        echo "</tr>";
        echo "<tr>";
        echo "<td width='350' style='vertical-align: bottom;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TOTAL</td>";
        echo "<td width='120' style='vertical-align: bottom;'>" . number_format($total, 2) . "</td>";
