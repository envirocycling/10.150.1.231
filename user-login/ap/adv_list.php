            ...
            <div class="middle">
                ...
                <div class="container">
                    <main class="content">
                            ...
                            <table class="data display datatable" id="example">
                                ...
                                if (isset($_POST['from'])) {
                                    ...
                                    if ($branch_id == '7') {
                                        ...
                                        if ($_POST['status'] == '') {
                                            $sql_data = mysql_query("SELECT * FROM adv WHERE branch_id='$branch_id' and date>='$date_from' and date<='$date_to' and acpty_id='2'");
                                        } else if ($_POST['status'] == 'pending') {
                                            $sql_data = mysql_query("SELECT * FROM adv WHERE branch_id='$branch_id' and date>='$date_from' and date<='$date_to' and status='' and acpty_id='2'");
                                        } else {
                                            $sql_data = mysql_query("SELECT * FROM adv WHERE branch_id='$branch_id' and date>='$date_from' and date<='$date_to' and status='" . $_POST['status'] . "' and acpty_id='2'");
                                        }
                                    }
                                } else {
                                    if ($branch_id == '7') {
                                        ...
                                        $sql_data = mysql_query("SELECT * FROM adv WHERE branch_id='$branch_id' and status='approved' and acpty_id='2'");
                                    }
                                }
						...
						<br>
						&nbsp;&nbsp;&nbsp;<button class="small-submit" onclick="tableToExcel('example', 'Supplier Advances List')"  class="button">XLS</button>
						<br><br>
                    </main><!-- .content -->
                </div><!-- .container-->
