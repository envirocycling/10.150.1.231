$(window).load(function () {
				...
				var count3 = Number($("#hidden-count1").val());
					...
					if(myId[0] == 'cancelbal'){
						...
						var c_remaining1 = $('#expense_' + myId[1]).html().replace(/\,/g,"");
					...
					var ex_sau1 = $('#exval_' + sau).val().replace(/\,/g,"");
						...
						var c2 = count2;
                                                var ex_toto = Number($("#ofr").val());
                                                var expense =  Number($('#txt_disss_' + myId[1]).html().replace(/\,/g,"")) - addfund;
                                                var ex = Number($('#exval_' + myId[1]).val());

						$('#hidden-count').val(c2);
						$('#hidden-count1').val("0");
						$("#expense_" + myId[1]).html(ex);
						$("#exval_" + myId[1]).val(ex);
						...
						//$("#ofr").val(ofr1);
                                                ...
                                                //$("#ofr").val(expense + ex_toto);
                                                //$("#t_fund").html(expense + ex_toto);
			 ...
			 function c(id){
				...
				var sau = '6';
				 ...
				 if(myId[0] == 'exval'){
					...
					//alert(re_split[1]);
					$('#txt_disss_' + myId[1]).html(remaining);
					var expense = Number($('#txt_disss_' + myId[1]).html());
					var addfund = Number($('#addval_' + myId[1]).val());
					var totreq = (expense + addfund).toFixed(2);
						...
						var reval_sau1 = $('#txt_disss_' + sau).html().replace(/\,/g,"");
						var reval_sau = Number(reval_sau1);
                                                var reval_pamp1 = $('#txt_disss_' + pamp).html().replace(/\,/g,"");
						var reval_pamp = Number(reval_pamp1);
						var reval_cai1 = $('#txt_disss_' + cai).html().replace(/\,/g,"");
						var reval_cai = Number(reval_cai1);
						var reval_cal1 = $('#txt_disss_' + cal).html().replace(/\,/g,"");
						var reval_cal = Number(reval_cal1);
						var reval_cav1 = $('#txt_disss_' + cav).html().replace(/\,/g,"");
						var reval_cav = Number(reval_cav1);
						var reval_kay1 = $('#txt_disss_' + kay).html().replace(/\,/g,"");
						var reval_kay = Number(reval_kay1);
						var reval_man1 = $('#txt_disss_' + man).html().replace(/\,/g,"");
						var reval_man = Number(reval_man1);
						var reval_pas1 = $('#txt_disss_' + pas).html().replace(/\,/g,"");
						var reval_pas = Number(reval_pas1);
						var reval_urd1 = $('#txt_disss_' + urd).html().replace(/\,/g,"");
						var reval_urd = Number(reval_urd1);
