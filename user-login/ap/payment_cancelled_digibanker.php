            ...
            <div class="middle">
                ...
                <div class="container">
                    <main class="content">
                        ...
                        <br>
                        <h2>CANCELLED DIGI PAYMENTS</h2>
                        <br>
                        <form action="payment_cancelled_digibanker.php" method="POST">
                            <?php
                            if (isset($_POST['from'])) {
                                ...
                                echo '<iframe src="iframe/payment_cancelled_digibanker.php?from=' . $_POST['from'] . '&to=' . $_POST['to'] . '" width="750" height="500" scrolling="yes"></iframe>';
                            } else {
                                echo 'From: <input class="tcal" type="text" name="from" value="' . date('Y/m/d') . '" size="10" required> To: <input type="text" class="tcal" name="to" value="' . date('Y/m/d') . '" size="10" required>
                                        <input class="submit" type="submit" name="submit" value="Submit">';
                                echo '<iframe src="iframe/payment_cancelled_digibanker.php" width="750" height="500" scrolling="yes"></iframe>';
                            }
                            ?>
                        </form>
                        <br>
