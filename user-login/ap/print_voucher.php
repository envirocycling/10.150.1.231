...
// Conversion
        ...
        echo "</tr>";
        echo "<tr>";
        echo "<td height='19' align='center'>* * * " . strtoupper(utf8_encode($rs_payment['cheque_name'])) . " * * *</td>";
        ...
        echo "<tr>";
        echo "<td>";
        echo "<div style='margin-left: -20px; margin-top: 15px;'>";
        echo "<br><br><br>";
        $sig_array = array();
