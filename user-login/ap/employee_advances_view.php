            ...
            <div class="middle">
                ...
                <div align="center">
                    ...
                    <table class="table">
						...
						<?php }?>
                            <tr>
                                <td colspan="4" align="right"><?php if($row_advances['status'] == 'approved' || $row_advances['status'] == 'issued'){ ?><input type="button" class="large-submit" value="Print" onClick="buttons(this.id)" id="<?php echo $row_advances['ea_id'];?>" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php }?><?php if($row_advances['status'] == 'approved'){?><input type="button" class="large-submit2" value="Issued" onClick="received()" id="btn_rec" disabled><input type="hidden" id="received" value="<?php echo $row_advances['ea_id'];?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php }?><input type="button" value="Back" id="back" onClick="btn_back()" class="large-submit" ></td>
                            </tr>
                        </table>
