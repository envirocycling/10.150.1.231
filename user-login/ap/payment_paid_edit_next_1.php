        ...
        <script>
            ...
            function print_voucher() {
                ...
                if (account == '') {
                    ...
                    if (cheque_name == '') {
                        var dataString = 'cheque_no=' + cheque_no + '&cheque_name=' + cheque_name_new + '&account=' + account + '&supplier_id=' + supplier_id + '&old_cheque_no=' + old_cheque_no;
                    } else {
                        var dataString = 'cheque_no=' + cheque_no + '&cheque_name=' + cheque_name + '&account=' + account + '&supplier_id=' + supplier_id + '&old_cheque_no=' + old_cheque_no;
                    }
            ...
            function print_cheque() {
                ...
                if (account == '') {
                    ...
                    if (checker == 0) {
                        ...
                        if (cheque_name == '') {
                            var dataString = 'cheque_no=' + cheque_no + '&cheque_name=' + cheque_name_new + '&account=' + account + '&tras_array=' + tras_array + '&supplier_id=' + supplier_id + '&old_cheque_no=' + old_cheque_no + '&payment_id=' + payment_id;
                        } else {
                            var dataString = 'cheque_no=' + cheque_no + '&cheque_name=' + cheque_name + '&account=' + account + '&tras_array=' + tras_array + '&supplier_id=' + supplier_id + '&old_cheque_no=' + old_cheque_no + '&payment_id=' + payment_id;
                        }
                        $.ajax({
                            type: "POST",
                        ...
                        var finish = "<a href='payment_paid.php'><button>Finish</button></a>";
            ...
            <div class="middle">
                ...
                <div class="container">
                    <main class="content">
                        ...
                        echo "<option value='" . $_POST['bank_code'] . "'>" . $_POST['bank_code'] . "</option>";
                        ...
                        echo "<td><input id='old_cheque_no' type='text' name='cheque_no' value='" . $_POST['c_cheque_no'] . "' readonly></td>";
                        echo "</tr>";
                        echo "<tr height='30'>";
                        echo "<td>AP:</td>";
                        ...
                        echo "<td><input type='text' name='cheque_name_old' value='" . $_POST['cheque_name'] . "'></td>";
                        echo "</tr>";
                        echo "</tr>";
                        echo "<tr>";
                        echo "<td></td>";
