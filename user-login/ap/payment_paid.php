            ...
            <div class="middle">
                ...
                <div class="container">
                    <main class="content">
                        ...
                        <br>
                        <h2>PAID CHEQUE PAYMENTS</h2>
                        <br>
                        <form action="payment_paid.php" method="POST">
                            <?php
                            if (isset($_POST['from'])) {
                                ...
                                echo 'Type: <select name="types">';
                                if ($_POST['types'] != '') {
                                    echo '<option value="' . $_POST['types'] . '">' . $_POST['types'] . '</option>';
                                }
                                ...
                                echo '<iframe src="iframe/payment_paid.php?from=' . $_POST['from'] . '&to=' . $_POST['to'] . '&type=' . $_POST['types'] . '" width="750" height="500" scrolling="yes"></iframe>';
                            } else {
                                echo 'From: <input class="tcal" type="text" name="from" value="' . date('Y/m/d') . '" size="10" required> To: <input type="text" class="tcal" name="to" value="' . date('Y/m/d') . '" size="10" required>
                                        ...
                                        <input class="submit" type="submit" name="submit" value="Submit">';
                                echo '<iframe src="iframe/payment_paid.php" width="750" height="500" scrolling="yes"></iframe>';
                            }
                            ?>
                        </form>
                ...
                <aside class="left-sidebar">
                    <iframe src="template/pending2.php" width="367" height="670" scrolling="yes"></iframe>
                </aside><!-- .left-sidebar -->
