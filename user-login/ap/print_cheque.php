...
// conversion
    ...
    echo "</tr>";
    echo "<tr height='15'>";
    echo "<td align='center' width='480'>***"; if(empty($rs_cheque['cheque_name2'])){echo strtoupper(utf8_encode($rs_cheque['cheque_name']));}else{echo strtoupper(utf8_encode($rs_cheque['cheque_name2']));} echo "***</td>";
