...
<html>
    ...
    <body>
        <div class="wrapper">
			...
			if(isset($_POST['submit'])){
			?>
			<iframe frameborder="0" width="100%" height="850px" src="iframe/fund_transfer.php?date=<?php echo $_POST['date'];?>" name="fund_transfer"></iframe>
			<?php }else{?>
				<iframe frameborder="0" width="100%" height="850px" src="iframe/fund_transfer.php" name="fund_transfer"></iframe>
			<?php }?>
			 </center>
            </div><!--.middle-->
