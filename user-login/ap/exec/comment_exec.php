...
if (isset($_POST['action']) && $_POST['action'] == 'select') {
    $sql = mysql_query("SELECT * FROM comments WHERE tbl='" . $_POST['tbl'] . "' and row_id='" . $_POST['row_id'] . "'");
...
if (isset($_POST['action']) && $_POST['action'] == 'insert') {
    $comment = mysql_real_escape_string(utf8_encode($_POST['comment']));
...
if (isset($_POST['action']) && $_POST['action'] == 'delete') {
    mysql_query("DELETE FROM comments WHERE comment_id='" . $_POST['comment_id'] . "'");
}
?>