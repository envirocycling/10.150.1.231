    ...
    <head>
        ...
        <script>
            ...
            function print_voucher() {
                var payment_id = $("#payment_id").val();
                window.open("print_adv_digibanker.php?payment_id=" + payment_id, 'mywindow', 'width=1200,height=600,left=50,top=50');
            }
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td colspan="4">
                                    ...
                                    <a href='clear_temp.php'><button id='save_online' class='large-submit' onclick='save_online();'>Process</button></a>  
