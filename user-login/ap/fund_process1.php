...
<html>
    <head>
		...
		<script type="text/javascript" src="js/fund_process3.js"></script>
    </head>
    ...
    <body>
        <div class="wrapper">
			...
			<?php
				...
				while($row_branch = mysql_fetch_array($sql_branch)){
					...
					echo '<tr>
							...
							<td><div id="txt_mbal"><span id="mbal_'.$row_branch['branch_id'].'">'.number_format($maintaining, 2).'</span></div><div class="txt_en" id="bal_'.$row_branch['branch_id'].'"><span ><input type="number" id="mbalval_'.$row_branch['branch_id'].'" value="'.round($maintaining,2).'" class="txtbox" onkeyup="c(this.id);"></span></div></td>
							...
							<td><div class="disable" id="disbutton_'.$row_branch['branch_id'].'"><img src="images/ok.png" title="Save" width="30%" height="50%"> | <img src="images/cancel.png" title="Cancel" width="30%" height="40%"></div>
			...
			?>	
				...
				<tr>
					<td colspan="10"><center>Available Fund: <input type="number" class="fund_available" id="avbl_fund" value="<?php echo $row_av['amount'];?>" onKeyUp="c(this.id);" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Submit" class="submit" id="fund_available1" onClick="save();"></center></td>
				</tr>
