        ...
        <div class="wrapper">
            ...
            <div class="middle">
                <div style="margin-left: 20px;">
                    ...
                    <br>
                    <form action="report_expense_result.php" method="POST">
                        <?php
                        if (isset($_POST['from'])) {
                    ...
                    <?php
                    if (isset($_POST['from'])) {
                        echo '<iframe src="iframe/query_report_expense.php?from=' . $_POST['from'] . '&to=' . $_POST['to'] . '&bank=' . $_POST['bank'] . '&type=' . $_POST['type'] . '" width="1160" height="500" scrolling="yes"></iframe>';
                        echo "<br><br>";
                    } else {
