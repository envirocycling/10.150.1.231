...
if ($rs_count == 0) {
    ...
    mysql_query("INSERT INTO payment (`bank_code`, `cheque_no`, `voucher_no`, `cheque_name`, `sub_total`, `ts_fee`, `adjustments`, `grand_total`, `type`, `pay_type`, `ap`, `verifier`, `signatory`, `date`,`cheque_date`)
    VALUES ('" . $rs_save['bank_code'] . "','" . $rs_save['cheque_no'] . "','" . $rs_save['voucher_no'] . "','$cheque_name','" . $rs_save['sub_total'] . "','" . $rs_save['ts_fee'] . "','" . $rs_save['adjustments'] . "','" . $rs_save['grand_total'] . "', '" . $rs_save['type'] . "', 'Advances', '" . $rs_save['ap'] . "', '" . $rs_save['verifier'] . "', '" . $rs_save['signatory'] . "','$my_date', '" . $rs_save['cheque_date'] . "')");
