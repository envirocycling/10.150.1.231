        ...
        <div class="wrapper">
            ...
            <div class="middle">
                ...
                <div style="margin-left: 30px; padding: 5px;">
                    ...
                    <br>
                    <form action="query_tipco.php" method="POST">
                        <?php
                        if (isset($_POST['from'])) {
                ...
                <?php
                if (isset($_POST['from'])) {
                    echo '<iframe src="iframe/query_tipco.php?from=' . $_POST['from'] . '&to=' . $_POST['to'] . '" width="1190" height="500" scrolling="yes"></iframe>';
                } else {
                    echo '<iframe src="iframe/query_tipco.php?from=' . date("Y/m/d") . '&to=' . date("Y/m/d") . '" width="1190" height="500" scrolling="yes"></iframe>';
                }
                ?>
