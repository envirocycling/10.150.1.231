...
function save($cheque_date, $trans_data) {
    ...
    foreach ($trans_array as $trans_id) {
        mysqli_query($conn, "UPDATE scale_receiving SET payment_id='" . maxId() . "',voucher_no='" . $rs_save['voucher_no'] . "', cheque_no='" . $rs_save['cheque_no'] . "', status='paid', date_paid='" . date("Y/m/d") . "' WHERE trans_id='$trans_id'");
    }
