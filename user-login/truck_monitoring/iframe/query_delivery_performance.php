    ...
    while ($row = mysql_fetch_array($result)) {
        ...
        while ($select_row = mysql_fetch_array($select)) {
          ...
          //  $text_date = $tex_date_row['text'];
            ...
            $select_rec = mysql_query("SELECT * from scale_receiving_details WHERE detail_id='" . $select_row['rec_detail_id'] . "'") or die(mysql_error());
            $select_rec = mysql_fetch_array($select_rec);
