    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="middle" align='center'>
                ...
                <br>
                <a href="pricing.php">SUPPLIERS</a> | <a href="mat_prices.php">MATERIALS</a> | <a href="update_all_prices.php">UPDATE ALL</a>
                <br>
                <iframe src="iframe/query_mat_prices.php"  width="1190" height="500" scrolling="yes"></iframe>
            </div><!-- .middle-->
