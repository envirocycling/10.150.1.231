...
while ($rs_sup = mysql_fetch_array($sql_sup)) {
    ...
    echo "<td class='data'>";
    echo "<a rel='facebox' href='../edit_prices.php?sup_id=" . $rs_sup['id'] . "_" . $rs_sup['supplier_name'] . "&branch=" . $_GET['branch'] . "'><button class='button'>Edit</button></a><br>";
    echo "<a rel='facebox' href='../sup_prices.php?sup_id=" . $rs_sup['id'] . "'><button class='button'>Prices</button></a>";
    echo "</td>";
    echo "</tr>";
}
echo "</table>";
