                    ...
                    <div class="table">
                        <table class="data display datatable" id="example">
                            ...
                            if (isset($_POST['from'])) {
								...
								if ($branch_id == ""){
									$sql_data = mysql_query("SELECT * FROM adv WHERE date>='$date_from' and date<='$date_to' and status!='cancelled'");
									// echo "SELECT * FROM adv WHERE date>='$date_from' and date<='$date_to' and status!='cancelled'";
								} else {
									$sql_data = mysql_query("SELECT * FROM adv WHERE branch_id='$branch_id' and date>='$date_from' and date<='$date_to' and status!='cancelled'");
									// echo "SELECT * FROM adv WHERE branch_id='$branch_id' and date>='$date_from' and date<='$date_to' and status!='cancelled'";
								}
                            } else {
								if ($branch_id == ""){
									$sql_data = mysql_query("SELECT * FROM adv WHERE status='verified'");
									// echo "SELECT * FROM adv WHERE status='verified'";
								} else {
									$sql_data = mysql_query("SELECT * FROM adv WHERE branch_id='$branch_id' and status='verified'");
									// echo "SELECT * FROM adv WHERE branch_id='$branch_id' and status='verified'";
								}
                            }
                            ...
                            while ($rs_data = mysql_fetch_array($sql_data)) {
                                ...
                                if ($rs_data['status'] == 'disapproved') {
                                    echo "<td>" . strtoupper($rs_data['status']) . " BY BH</td>";
                                } else {
                                    echo "<td></td>";
                                }
