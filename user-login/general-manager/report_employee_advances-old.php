                ...
                <div style="margin-left: 20px;">
                    ...
                    if (isset($_POST['submit'])) {
                       ...
                       <?php while ($rs_eadv = mysql_fetch_array($sql_eadv)) {
                            ...
                            if(empty($chk_dateissued) || $chk_dateissued < 0){$date_issued = '';}
                            if(empty($chk_liquidated) || $chk_liquidated < 0){$date_liquidated = '';}
                           ...
                           echo '<tr>
                                    ...
                                    <td class="data">';
                                                      ...
                                                      if($rs_eadv['status']=='issued'){ echo $age_days->format('%a');}echo '</td>
                                    <td class="data">'.ucwords($row_approver['firstname']).', '.ucwords($row_approver['lastname']).'</td>
                                    <td class="data">'.ucwords($row_preparedby['firstname']).', '.ucwords($row_preparedby['lastname']).'</td>
                                 </tr>';
